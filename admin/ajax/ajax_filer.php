<?php
	...
	$folderfiler = (isset($_POST['folderfiler'])) ? htmlspecialchars($_POST['folderfiler']) : '';
	...
	if($cmd == 'refresh' && ($idmuc >= 0 || $hash != ''))
	{
		...
		if($gallery)
		{
			...
			{
				echo $func->galleryFiler($gallery[$i]['stt'],$gallery[$i]['id'],$gallery[$i]['photo'],$gallery[$i]['tenvi'],$folderfiler,$colfiler);
			}
