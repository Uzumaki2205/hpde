<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        $('body').on('change','.my-jFiler-item-info', function(){
			...
			var colfiler = $(".col-filer").val();
			var actfiler = $(".act-filer").val();
			var folderfiler = $(".folder-filer").val();
			var cmd = 'info';
			...
			$.ajax({
				...
				url: 'ajax/ajax_filer.php',
				async: false,
				data: {id:id,idmuc:idmuc,info:info,value:value,com:com,kind:actfiler,type:type,folderfiler:folderfiler,colfiler:colfiler,cmd:cmd,hash:'<?=$func->generateHash()?>'},
				success: function(result)
				{
					destroySortFiler();
