<?php
    ...
    $config['product'][$nametype]['check'] = array("noibat" => "Nổi bật","btn_new" => "SP mới");
    ...
    $config['product'][$nametype]['specifications_cke'] = true;
    $config['product'][$nametype]['highlights'] = true;
    $config['product'][$nametype]['highlights_cke'] = true;
    ...
    $config['product'][$nametype]['width_list'] = 460;
    $config['product'][$nametype]['height_list'] = 600;
    $config['product'][$nametype]['thumb_list'] = '460x300x1';
    ...
    /* Sản phẩm (Hãng) */
    $config['product'][$nametype]['title_main_brand'] = "Thương hiệu sản phẩm";
