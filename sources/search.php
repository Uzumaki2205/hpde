<?php  
	...
	if(isset($_GET['keyword']))
	{
		...
		if($tukhoa)
		{
			...
			$params = array("product","%$tukhoa%","%$tukhoa%","%$tukhoa%");

			$curPage = $get_page;
			$per_page = 20;
			$startpoint = ($curPage * $per_page) - $per_page;
			$limit = " limit ".$startpoint.",".$per_page;
			$sql = "select photo, ten$lang, mota$lang, tenkhongdauvi, tenkhongdauen, giamoi, gia, giakm, id from #_product where $where order by stt,id desc $limit";
