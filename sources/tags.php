<?php  
	...
	{
		/* Lấy tag detail */
		$tags_detail = $d->rawQueryOne("select id, ten$lang, type, photo, tenkhongdauvi, tenkhongdauen from #_tags where id = ? and type = ? limit 0,1",array($id,$type));
		...
		if($img_json_bar['p'] != $tags_detail['photo'])
		{
